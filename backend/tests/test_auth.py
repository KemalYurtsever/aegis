...
def test_roles_enforce_admin_management_and_viewer_read_only(client):
    ...
    assert client.post(
        ...
        json={"name": "Forbidden", "ip_address": "192.168.1.20", "device_type": "Other", "is_active": True},
    ).status_code == 403
...
def test_operator_can_manage_devices_but_not_users(client):
    ...
    assert client.post(
        ...
        json={"name": "Managed", "ip_address": "192.168.1.30", "device_type": "Other", "is_active": True},
    ).status_code == 201
