...
DEVICE = {
    "name": "Unknown device", "ip_address": "192.168.56.70", "device_type": "Other",
...
def test_fingerprint_ports_are_probed_in_one_bounded_wave(monkeypatch):
    ...
    evidence = fingerprint_service.fingerprint_target("192.168.56.70")
...
def test_batch_fingerprints_keep_evidence_with_the_correct_target(monkeypatch):
    ...
    evidence = fingerprint_targets([
        ("192.168.56.70", "Printer vendor", None),
        ("192.168.56.71", "Server vendor", "ssh"),
    ])
