...
def test_generic_provider_ptr_is_not_treated_as_device_name():
    assert is_generic_ptr_hostname("198.19.4.14", "198-19-4-14.ptr.example.test") is True
    assert is_generic_ptr_hostname("198.19.4.14", "office-printer.local") is False
