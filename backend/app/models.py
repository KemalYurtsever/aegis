...
class VulnerabilityFinding(Base):
    ...
    validation_tool: Mapped[str | None] = mapped_column(String(30), nullable=True)
    validation_check_id: Mapped[str | None] = mapped_column(String(200), nullable=True)
    validation_target: Mapped[str | None] = mapped_column(String(500), nullable=True)
    validation_reference: Mapped[str | None] = mapped_column(String(500), nullable=True)
